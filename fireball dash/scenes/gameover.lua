...
function scene:create( event )
	...
	local restart = display.newImageRect( "assets/buttons/restart.png", 120, 120 )
	restart.x = 80
	restart.y = display.contentCenterY + 90
	sceneGroup:insert(restart)

	local homeButton = display.newImageRect( "assets/buttons/menu.png", 130, 130 )
	homeButton.x = 240
	homeButton.y = display.contentCenterY + 90
